...
describe('Integration Test', () => {
    ...
    step(`create multiple transactions (${multipleTransactions} transactions)`, () => {
        for(let i = 0; i < multipleTransactions; i++) {
            createTransaction(context, 1000000000 / multipleTransactions)
        }
    });
